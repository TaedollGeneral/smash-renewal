...
export function Sidebar({
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed top-0 left-0 h-full w-80 bg-[#1C5D99] z-50 transform transition-transform duration-300 ease-out ${
        ...
        <div className="overflow-y-auto h-[calc(100%-72px)] p-4 flex flex-col gap-6">
          ...
          {user && (
            <button
              ...
              className="w-full flex items-center justify-center gap-2 p-3 text-white hover:bg-white/20 rounded-lg transition-colors border border-white/40 hover:border-white/60"
            >
