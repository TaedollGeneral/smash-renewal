...
# gunicorn이 SIGKILL 등 비정상 종료 시 gunicorn.ctl 소켓 파일이 남아있으면
# 재시작 시 "Control server error: Address already in use" 오류가 반복 발생한다.
# on_starting 훅에서 미리 제거하여 재시작 안정성을 확보한다.
